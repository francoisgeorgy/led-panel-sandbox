...
from panel.emulator.logger import Logger

adapters = [
    {
        'path': 'panel.emulator.adapters.cube_browser_adapter.adapter',
        'class': 'CubeBrowserAdapter',
        'type': 'cube_browser'
    },
    {
        'path': 'panel.emulator.adapters.browser_adapter.adapter',
        'class': 'BrowserAdapter',
        'type': 'browser'
    },
    {
        'path': 'panel.emulator.adapters.pygame_adapter',
        'class': 'PygameAdapter',
        'type': 'pygame'
    },
    {
        'path': 'panel.emulator.adapters.sixel_adapter',
        'class': 'SixelAdapter',
        'type': 'sixel'
    },
    {
        'path': 'panel.emulator.adapters.terminal_adapter',
        'class': 'TerminalAdapter',
        'type': 'terminal'
    },
    {
        'path': 'panel.emulator.adapters.tkinter_adapter',
        'class': 'TkinterAdapter',
        'type': 'tkinter'
    },
    {
        'path': 'panel.emulator.adapters.turtle_adapter',
        'class': 'TurtleAdapter',
        'type': 'turtle'
    }
]
